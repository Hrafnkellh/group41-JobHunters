...
urlpatterns = [
    ...
    path(route='<int:id>/jobApp1/', view=views.JAP_1_1, name='jobApp_1_1'),
    path(route='<int:id>/jobApp2/', view=views.JAP_1_2, name='jobApp_1_2'),
    path(route='<int:id>/jobApp3/', view=views.JAP_1_3, name='jobApp_1_3'),
